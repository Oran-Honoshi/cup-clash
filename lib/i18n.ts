...
export interface Translations {
  ...
  nav_stats:         string;
  nav_testing:       string;
  nav_delete_user:   string;
  nav_legacy_dashboard: string;
  nav_section_social:      string;
  nav_section_game:        string;
  nav_section_predictions: string;
  nav_section_tournament:  string;
  sidebar_tagline:   string;
  sidebar_guest_heading: string;
  sidebar_guest_body: string;
  nav_table:         string;
  nav_mybets:        string;
  ...
  notif_push_match_duel_body:          string;
  ...
  cg_mode_question:      string;
  cg_house_rules_title:  string;
  cg_house_rules_badge:  string;
  cg_house_rules_desc:   string;
  cg_customizable_title: string;
  cg_customizable_desc:  string;
  cg_competition_label:  string;
  ...
  oracle_game_history_link:      string;
  oracle_history_page_title:     string;
  oracle_history_page_subtitle:  string;
  oracle_history_filter_mine:    string;
  oracle_history_filter_all:     string;
  oracle_history_filter_empty:   string;
  ...
  // Match Duel — human-vs-human head-to-head score prediction on a chosen
  // match (match_duels, migration 066). Distinct from both the 1v1 Daily
  // Duel (daily_duels, today's word puzzle only) and Oracle Duel (vs the
  // Oracle, not a friend); a friend may be challenged in-app or via a
  // shareable invite link that works before they even have an account.
  match_duel_widget_title:              string;
  match_duel_sign_in_required:          string;
  match_duel_challenge_cta:             string;
  match_duel_empty:                     string;
  match_duel_waiting_claim:             string;
  match_duel_share_again:               string;
  match_duel_challenged_you:            string;
  match_duel_waiting_response:          string;
  match_duel_declined:                  string;
  match_duel_your_pick:                 string;
  match_duel_score_submit:              string;
  match_duel_locked_no_pick:            string;
  match_duel_back:                      string;
  match_duel_step_pick_match_title:     string;
  match_duel_search_match_placeholder:  string;
  match_duel_no_matches_found:          string;
  match_duel_link_copied:               string;
  match_duel_share_link_cta:            string;
  match_duel_pick_friend_cta:           string;
  match_duel_search_friend_placeholder: string;
  match_duel_no_players_found:          string;
  match_duel_join_group_hint:           string;
  match_duel_share_text:                string;
  match_duel_result_win:                string;
  match_duel_result_lose:               string;
  match_duel_result_tie:                string;
  match_duel_invalid_title:             string;
  match_duel_invalid_body:              string;
  match_duel_own_invite:                string;
  match_duel_back_to_game:              string;
  match_duel_invited_by:                string;
  match_duel_already_claimed:           string;
  match_duel_lock_note:                 string;
  match_duel_accept_cta:                string;
...
const en: Translations = {
  ...
  nav_stats:         "Stats",
  nav_testing:       "Testing",
  nav_delete_user:   "Delete User",
  nav_legacy_dashboard: "Legacy Dashboard",
  nav_section_social:      "Social",
  nav_section_game:        "Game",
  nav_section_predictions: "Predictions",
  nav_section_tournament:  "Tournament",
  sidebar_tagline:   "Prediction League",
  sidebar_guest_heading: "Ready to compete?",
  sidebar_guest_body: "Save picks, join groups, and climb the leaderboard.",
  nav_table:         "Table",
  nav_mybets:        "My Picks",
  ...
  notif_push_match_duel: "Match Duel result",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — you {userScore} pts, your opponent {opponentScore} pts.",
  ...
  cg_mode_question:      "How do you want to run this group?",
  cg_house_rules_title:  "House Rules",
  cg_house_rules_badge:  "No setup",
  cg_house_rules_desc:   "Standard scoring, ready to go. Pick a competition and you're playing.",
  cg_customizable_title: "Customizable",
  cg_customizable_desc:  "Set your own scoring, prize pool, and buy-in.",
  cg_competition_label:  "Competition",
  ...
  oracle_game_history_link: "See full history →",
  oracle_history_page_title: "Oracle History",
  oracle_history_page_subtitle: "Every match the Oracle has predicted.",
  oracle_history_filter_mine: "Your matches",
  oracle_history_filter_all: "All Oracle picks",
  oracle_history_filter_empty: "No matches here yet.",
  ...
  match_duel_widget_title: "Match Duel",
  match_duel_sign_in_required: "Sign in to challenge a friend to a match.",
  match_duel_challenge_cta: "Challenge a friend",
  match_duel_empty: "No match duels yet — challenge a friend to a head-to-head score prediction.",
  match_duel_waiting_claim: "Waiting for someone to claim your link",
  match_duel_share_again: "Share again",
  match_duel_challenged_you: "Challenged you",
  match_duel_waiting_response: "Waiting for response",
  match_duel_declined: "Declined",
  match_duel_your_pick: "Your pick: {home}-{away}",
  match_duel_score_submit: "Submit",
  match_duel_locked_no_pick: "Locked — no pick submitted",
  match_duel_back: "Back",
  match_duel_step_pick_match_title: "Pick a match",
  match_duel_search_match_placeholder: "Search by team…",
  match_duel_no_matches_found: "No upcoming matches found.",
  match_duel_link_copied: "Copied!",
  match_duel_share_link_cta: "Share invite link",
  match_duel_pick_friend_cta: "Pick from your groups",
  match_duel_search_friend_placeholder: "Search by name…",
  match_duel_no_players_found: "No players found.",
  match_duel_join_group_hint: "Join a group to see group-mates here, or search by name.",
  match_duel_share_text: "I challenged you to predict {home} vs {away}! Think you can beat me?",
  match_duel_result_win: "You won",
  match_duel_result_lose: "You lost",
  match_duel_result_tie: "Tied",
  match_duel_invalid_title: "Invalid Link",
  match_duel_invalid_body: "This duel invite doesn't match any match. Ask your friend for a new one.",
  match_duel_own_invite: "This is your own invite link — share it with a friend instead.",
  match_duel_back_to_game: "Back to Game Room",
  match_duel_invited_by: "Invited by",
  match_duel_already_claimed: "This invite has already been claimed.",
  match_duel_lock_note: "Predictions lock 5 min before kickoff",
  match_duel_accept_cta: "Accept challenge",
...
const fr: Translations = {
  ...
  nav_summary:       "Résumé",
  nav_scores:        "Scores",
  nav_game:          "Salle de jeux",
  nav_stats:         "Statistiques",
  nav_testing:       "Tests",
  nav_delete_user:   "Supprimer l'utilisateur",
  nav_legacy_dashboard: "Ancien tableau de bord",
  nav_section_social:      "Social",
  nav_section_game:        "Jeu",
  nav_section_predictions: "Pronostics",
  nav_section_tournament:  "Tournoi",
  sidebar_tagline:   "Ligue de pronostics",
  sidebar_guest_heading: "Prêt à jouer ?",
  sidebar_guest_body: "Enregistre tes pronostics, rejoins des groupes et grimpe au classement.",
  nav_table:         "Tableau",
  ...
  notif_push_match_duel: "Résultat du Duel de match",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — vous {userScore} pts, votre adversaire {opponentScore} pts.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "Comment voulez-vous gérer ce groupe ?",
  cg_house_rules_title:  "Règles standard",
  cg_house_rules_badge:  "Aucune configuration",
  cg_house_rules_desc:   "Barème standard, prêt à l'emploi. Choisissez une compétition et jouez.",
  cg_customizable_title: "Personnalisable",
  cg_customizable_desc:  "Définissez votre propre barème, cagnotte et mise.",
  cg_competition_label:  "Compétition",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "Voir tout l'historique →",
  oracle_history_page_title: "Historique de l'Oracle",
  oracle_history_page_subtitle: "Tous les pronostics de l'Oracle.",
  oracle_history_filter_mine: "Vos matchs",
  oracle_history_filter_all: "Tous les pronostics de l'Oracle",
  oracle_history_filter_empty: "Aucun match ici pour l'instant.",
  ...
  match_duel_widget_title: "Duel de match",
  match_duel_sign_in_required: "Connectez-vous pour défier un ami sur un match.",
  match_duel_challenge_cta: "Défier un ami",
  match_duel_empty: "Aucun duel de match pour l'instant — défiez un ami sur un pronostic tête-à-tête.",
  match_duel_waiting_claim: "En attente que quelqu'un accepte votre lien",
  match_duel_share_again: "Repartager",
  match_duel_challenged_you: "Vous a défié",
  match_duel_waiting_response: "En attente de réponse",
  match_duel_declined: "Refusé",
  match_duel_your_pick: "Votre pronostic : {home}-{away}",
  match_duel_score_submit: "Valider",
  match_duel_locked_no_pick: "Verrouillé — aucun pronostic envoyé",
  match_duel_back: "Retour",
  match_duel_step_pick_match_title: "Choisir un match",
  match_duel_search_match_placeholder: "Rechercher une équipe…",
  match_duel_no_matches_found: "Aucun match à venir trouvé.",
  match_duel_link_copied: "Copié !",
  match_duel_share_link_cta: "Partager le lien d'invitation",
  match_duel_pick_friend_cta: "Choisir parmi vos groupes",
  match_duel_search_friend_placeholder: "Rechercher par nom…",
  match_duel_no_players_found: "Aucun joueur trouvé.",
  match_duel_join_group_hint: "Rejoignez un groupe pour voir vos coéquipiers ici, ou recherchez par nom.",
  match_duel_share_text: "Je te défie de pronostiquer {home} vs {away} ! Tu penses pouvoir me battre ?",
  match_duel_result_win: "Vous avez gagné",
  match_duel_result_lose: "Vous avez perdu",
  match_duel_result_tie: "Match nul",
  match_duel_invalid_title: "Lien invalide",
  match_duel_invalid_body: "Cette invitation ne correspond à aucun match. Demandez un nouveau lien à votre ami.",
  match_duel_own_invite: "C'est votre propre lien d'invitation — partagez-le avec un ami à la place.",
  match_duel_back_to_game: "Retour à la Salle de jeux",
  match_duel_invited_by: "Invité par",
  match_duel_already_claimed: "Cette invitation a déjà été acceptée.",
  match_duel_lock_note: "Les pronostics se verrouillent 5 min avant le coup d'envoi",
  match_duel_accept_cta: "Accepter le défi",
...
const de: Translations = {
  ...
  nav_scores:        "Ergebnisse",
  nav_game:          "Spielraum",
  nav_stats:         "Statistiken",
  nav_testing:       "Tests",
  nav_delete_user:   "Nutzer löschen",
  nav_legacy_dashboard: "Altes Dashboard",
  nav_section_social:      "Sozial",
  nav_section_game:        "Spiel",
  nav_section_predictions: "Tipps",
  nav_section_tournament:  "Turnier",
  sidebar_tagline:   "Tipp-Liga",
  sidebar_guest_heading: "Bereit mitzumachen?",
  sidebar_guest_body: "Speichere Tipps, tritt Gruppen bei und klettere in der Rangliste.",
  nav_table:         "Tabelle",
  ...
  notif_push_match_duel: "Match-Duell-Ergebnis",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — du {userScore} Pkt., dein Gegner {opponentScore} Pkt.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "Wie möchtest du diese Gruppe führen?",
  cg_house_rules_title:  "Hausregeln",
  cg_house_rules_badge:  "Keine Einrichtung",
  cg_house_rules_desc:   "Standardwertung, sofort einsatzbereit. Wettbewerb wählen und loslegen.",
  cg_customizable_title: "Anpassbar",
  cg_customizable_desc:  "Lege deine eigene Wertung, deinen Preispool und Einsatz fest.",
  cg_competition_label:  "Wettbewerb",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "Vollständigen Verlauf ansehen →",
  oracle_history_page_title: "Orakel-Verlauf",
  oracle_history_page_subtitle: "Alle Tipps, die das Orakel abgegeben hat.",
  oracle_history_filter_mine: "Deine Spiele",
  oracle_history_filter_all: "Alle Orakel-Tipps",
  oracle_history_filter_empty: "Hier gibt es noch keine Spiele.",
  ...
  match_duel_widget_title: "Match-Duell",
  match_duel_sign_in_required: "Melde dich an, um einen Freund zu einem Match herauszufordern.",
  match_duel_challenge_cta: "Freund herausfordern",
  match_duel_empty: "Noch keine Match-Duelle — fordere einen Freund zu einem direkten Tipp-Duell heraus.",
  match_duel_waiting_claim: "Warten, bis jemand deinen Link annimmt",
  match_duel_share_again: "Erneut teilen",
  match_duel_challenged_you: "Hat dich herausgefordert",
  match_duel_waiting_response: "Warten auf Antwort",
  match_duel_declined: "Abgelehnt",
  match_duel_your_pick: "Dein Tipp: {home}-{away}",
  match_duel_score_submit: "Absenden",
  match_duel_locked_no_pick: "Gesperrt — kein Tipp abgegeben",
  match_duel_back: "Zurück",
  match_duel_step_pick_match_title: "Match auswählen",
  match_duel_search_match_placeholder: "Team suchen…",
  match_duel_no_matches_found: "Keine bevorstehenden Spiele gefunden.",
  match_duel_link_copied: "Kopiert!",
  match_duel_share_link_cta: "Einladungslink teilen",
  match_duel_pick_friend_cta: "Aus deinen Gruppen auswählen",
  match_duel_search_friend_placeholder: "Nach Namen suchen…",
  match_duel_no_players_found: "Keine Spieler gefunden.",
  match_duel_join_group_hint: "Tritt einer Gruppe bei, um hier Gruppenmitglieder zu sehen, oder suche nach Namen.",
  match_duel_share_text: "Ich fordere dich heraus, {home} gegen {away} zu tippen! Denkst du, du kannst mich schlagen?",
  match_duel_result_win: "Du hast gewonnen",
  match_duel_result_lose: "Du hast verloren",
  match_duel_result_tie: "Unentschieden",
  match_duel_invalid_title: "Ungültiger Link",
  match_duel_invalid_body: "Diese Duell-Einladung passt zu keinem Match. Bitte deinen Freund um einen neuen Link.",
  match_duel_own_invite: "Das ist dein eigener Einladungslink — teile ihn stattdessen mit einem Freund.",
  match_duel_back_to_game: "Zurück zum Spielzimmer",
  match_duel_invited_by: "Eingeladen von",
  match_duel_already_claimed: "Diese Einladung wurde bereits angenommen.",
  match_duel_lock_note: "Tipps werden 5 Min. vor Anpfiff gesperrt",
  match_duel_accept_cta: "Herausforderung annehmen",
...
const nl: Translations = {
  ...
  nav_home:          "Home",
  nav_news:          "Nieuws",
  nav_summary:       "Overzicht",
  nav_scores:        "Uitslagen",
  nav_game:          "Speelkamer",
  nav_stats:         "Statistieken",
  nav_testing:       "Testen",
  nav_delete_user:   "Gebruiker verwijderen",
  nav_legacy_dashboard: "Oud dashboard",
  nav_section_social:      "Sociaal",
  nav_section_game:        "Spel",
  nav_section_predictions: "Voorspellingen",
  nav_section_tournament:  "Toernooi",
  sidebar_tagline:   "Voorspellingscompetitie",
  sidebar_guest_heading: "Klaar om mee te doen?",
  sidebar_guest_body: "Sla voorspellingen op, word lid van groepen en klim op het scorebord.",
  nav_table:         "Tabel",
  ...
  notif_push_match_duel: "Wedstrijdduel-resultaat",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — jij {userScore} pt, je tegenstander {opponentScore} pt.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "Hoe wil je deze groep beheren?",
  cg_house_rules_title:  "Huisregels",
  cg_house_rules_badge:  "Geen instellingen",
  cg_house_rules_desc:   "Standaardpuntentelling, direct klaar. Kies een competitie en speel.",
  cg_customizable_title: "Aanpasbaar",
  cg_customizable_desc:  "Stel je eigen puntentelling, prijzenpot en inleg in.",
  cg_competition_label:  "Competitie",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "Volledige geschiedenis bekijken →",
  oracle_history_page_title: "Orakelgeschiedenis",
  oracle_history_page_subtitle: "Alle voorspellingen die het Orakel heeft gedaan.",
  oracle_history_filter_mine: "Jouw wedstrijden",
  oracle_history_filter_all: "Alle Orakel-voorspellingen",
  oracle_history_filter_empty: "Hier staan nog geen wedstrijden.",
  ...
  match_duel_widget_title: "Wedstrijdduel",
  match_duel_sign_in_required: "Log in om een vriend uit te dagen voor een wedstrijd.",
  match_duel_challenge_cta: "Daag een vriend uit",
  match_duel_empty: "Nog geen wedstrijdduels — daag een vriend uit voor een rechtstreekse voorspelling.",
  match_duel_waiting_claim: "Wachten tot iemand je link accepteert",
  match_duel_share_again: "Opnieuw delen",
  match_duel_challenged_you: "Heeft je uitgedaagd",
  match_duel_waiting_response: "Wachten op reactie",
  match_duel_declined: "Afgewezen",
  match_duel_your_pick: "Jouw voorspelling: {home}-{away}",
  match_duel_score_submit: "Versturen",
  match_duel_locked_no_pick: "Vergrendeld — geen voorspelling ingediend",
  match_duel_back: "Terug",
  match_duel_step_pick_match_title: "Kies een wedstrijd",
  match_duel_search_match_placeholder: "Zoek op team…",
  match_duel_no_matches_found: "Geen aankomende wedstrijden gevonden.",
  match_duel_link_copied: "Gekopieerd!",
  match_duel_share_link_cta: "Uitnodigingslink delen",
  match_duel_pick_friend_cta: "Kies uit je groepen",
  match_duel_search_friend_placeholder: "Zoek op naam…",
  match_duel_no_players_found: "Geen spelers gevonden.",
  match_duel_join_group_hint: "Word lid van een groep om hier groepsgenoten te zien, of zoek op naam.",
  match_duel_share_text: "Ik daag je uit om {home} tegen {away} te voorspellen! Denk je dat je me kunt verslaan?",
  match_duel_result_win: "Je hebt gewonnen",
  match_duel_result_lose: "Je hebt verloren",
  match_duel_result_tie: "Gelijkspel",
  match_duel_invalid_title: "Ongeldige link",
  match_duel_invalid_body: "Deze duel-uitnodiging komt met geen enkele wedstrijd overeen. Vraag je vriend om een nieuwe link.",
  match_duel_own_invite: "Dit is je eigen uitnodigingslink — deel deze in plaats daarvan met een vriend.",
  match_duel_back_to_game: "Terug naar Game Room",
  match_duel_invited_by: "Uitgenodigd door",
  match_duel_already_claimed: "Deze uitnodiging is al geaccepteerd.",
  match_duel_lock_note: "Voorspellingen vergrendelen 5 min. voor aftrap",
  match_duel_accept_cta: "Uitdaging accepteren",
...
const es: Translations = {
  ...
  nav_game:          "Sala de juegos",
  nav_stats:         "Estadísticas",
  nav_testing:       "Pruebas",
  nav_delete_user:   "Eliminar usuario",
  nav_legacy_dashboard: "Panel anterior",
  nav_section_social:      "Social",
  nav_section_game:        "Juego",
  nav_section_predictions: "Pronósticos",
  nav_section_tournament:  "Torneo",
  sidebar_tagline:   "Liga de pronósticos",
  sidebar_guest_heading: "¿Listo para competir?",
  sidebar_guest_body: "Guarda tus pronósticos, únete a grupos y sube en la clasificación.",
  nav_table:         "Tabla",
  ...
  notif_push_match_duel: "Resultado del Duelo de partido",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — tú {userScore} pts, tu rival {opponentScore} pts.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "¿Cómo quieres gestionar este grupo?",
  cg_house_rules_title:  "Reglas estándar",
  cg_house_rules_badge:  "Sin configuración",
  cg_house_rules_desc:   "Puntuación estándar, lista para jugar. Elige una competición y listo.",
  cg_customizable_title: "Personalizable",
  cg_customizable_desc:  "Configura tu propia puntuación, bote de premios y cuota.",
  cg_competition_label:  "Competición",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "Ver historial completo →",
  oracle_history_page_title: "Historial del Oráculo",
  oracle_history_page_subtitle: "Todos los pronósticos que ha hecho el Oráculo.",
  oracle_history_filter_mine: "Tus partidos",
  oracle_history_filter_all: "Todos los pronósticos del Oráculo",
  oracle_history_filter_empty: "Aún no hay partidos aquí.",
  ...
  match_duel_widget_title: "Duelo de partido",
  match_duel_sign_in_required: "Inicia sesión para desafiar a un amigo en un partido.",
  match_duel_challenge_cta: "Desafiar a un amigo",
  match_duel_empty: "Aún no hay duelos de partido — desafía a un amigo a un pronóstico cara a cara.",
  match_duel_waiting_claim: "Esperando a que alguien acepte tu enlace",
  match_duel_share_again: "Compartir de nuevo",
  match_duel_challenged_you: "Te desafió",
  match_duel_waiting_response: "Esperando respuesta",
  match_duel_declined: "Rechazado",
  match_duel_your_pick: "Tu pronóstico: {home}-{away}",
  match_duel_score_submit: "Enviar",
  match_duel_locked_no_pick: "Bloqueado — no se envió ningún pronóstico",
  match_duel_back: "Atrás",
  match_duel_step_pick_match_title: "Elige un partido",
  match_duel_search_match_placeholder: "Buscar por equipo…",
  match_duel_no_matches_found: "No se encontraron próximos partidos.",
  match_duel_link_copied: "¡Copiado!",
  match_duel_share_link_cta: "Compartir enlace de invitación",
  match_duel_pick_friend_cta: "Elegir de tus grupos",
  match_duel_search_friend_placeholder: "Buscar por nombre…",
  match_duel_no_players_found: "No se encontraron jugadores.",
  match_duel_join_group_hint: "Únete a un grupo para ver aquí a tus compañeros, o busca por nombre.",
  match_duel_share_text: "¡Te desafío a pronosticar {home} vs {away}! ¿Crees que puedes ganarme?",
  match_duel_result_win: "Ganaste",
  match_duel_result_lose: "Perdiste",
  match_duel_result_tie: "Empate",
  match_duel_invalid_title: "Enlace no válido",
  match_duel_invalid_body: "Esta invitación al duelo no corresponde a ningún partido. Pídele a tu amigo un enlace nuevo.",
  match_duel_own_invite: "Este es tu propio enlace de invitación — compártelo con un amigo en su lugar.",
  match_duel_back_to_game: "Volver a la Sala de juegos",
  match_duel_invited_by: "Invitado por",
  match_duel_already_claimed: "Esta invitación ya fue aceptada.",
  match_duel_lock_note: "Los pronósticos se bloquean 5 min antes del inicio",
  match_duel_accept_cta: "Aceptar el desafío",
...
const pt: Translations = {
  ...
  nav_summary:       "Resumo",
  nav_scores:        "Resultados",
  nav_game:          "Sala de jogos",
  nav_stats:         "Estatísticas",
  nav_testing:       "Testes",
  nav_delete_user:   "Eliminar utilizador",
  nav_legacy_dashboard: "Painel antigo",
  nav_section_social:      "Social",
  nav_section_game:        "Jogo",
  nav_section_predictions: "Palpites",
  nav_section_tournament:  "Torneio",
  sidebar_tagline:   "Liga de palpites",
  sidebar_guest_heading: "Pronto para competir?",
  sidebar_guest_body: "Guarda os teus palpites, entra em grupos e sobe na tabela.",
  nav_table:         "Tabela",
  ...
  notif_push_match_duel: "Resultado do Duelo de Partida",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — você {userScore} pts, seu adversário {opponentScore} pts.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "Como queres gerir este grupo?",
  cg_house_rules_title:  "Regras padrão",
  cg_house_rules_badge:  "Sem configuração",
  cg_house_rules_desc:   "Pontuação padrão, pronta a usar. Escolhe uma competição e já está.",
  cg_customizable_title: "Personalizável",
  cg_customizable_desc:  "Define a tua própria pontuação, prémio e valor de entrada.",
  cg_competition_label:  "Competição",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "Ver histórico completo →",
  oracle_history_page_title: "Histórico do Oráculo",
  oracle_history_page_subtitle: "Todos os palpites que o Oráculo já fez.",
  oracle_history_filter_mine: "Suas partidas",
  oracle_history_filter_all: "Todos os palpites do Oráculo",
  oracle_history_filter_empty: "Ainda não há partidas aqui.",
  ...
  match_duel_widget_title: "Duelo de Partida",
  match_duel_sign_in_required: "Entre para desafiar um amigo em uma partida.",
  match_duel_challenge_cta: "Desafiar um amigo",
  match_duel_empty: "Ainda não há duelos de partida — desafie um amigo para um palpite cara a cara.",
  match_duel_waiting_claim: "Aguardando alguém aceitar seu link",
  match_duel_share_again: "Compartilhar novamente",
  match_duel_challenged_you: "Te desafiou",
  match_duel_waiting_response: "Aguardando resposta",
  match_duel_declined: "Recusado",
  match_duel_your_pick: "Seu palpite: {home}-{away}",
  match_duel_score_submit: "Enviar",
  match_duel_locked_no_pick: "Bloqueado — nenhum palpite enviado",
  match_duel_back: "Voltar",
  match_duel_step_pick_match_title: "Escolha uma partida",
  match_duel_search_match_placeholder: "Buscar por time…",
  match_duel_no_matches_found: "Nenhuma partida futura encontrada.",
  match_duel_link_copied: "Copiado!",
  match_duel_share_link_cta: "Compartilhar link de convite",
  match_duel_pick_friend_cta: "Escolher dos seus grupos",
  match_duel_search_friend_placeholder: "Buscar por nome…",
  match_duel_no_players_found: "Nenhum jogador encontrado.",
  match_duel_join_group_hint: "Entre em um grupo para ver seus colegas de grupo aqui, ou busque por nome.",
  match_duel_share_text: "Te desafio a palpitar em {home} x {away}! Acha que consegue me vencer?",
  match_duel_result_win: "Você venceu",
  match_duel_result_lose: "Você perdeu",
  match_duel_result_tie: "Empate",
  match_duel_invalid_title: "Link inválido",
  match_duel_invalid_body: "Este convite de duelo não corresponde a nenhuma partida. Peça um novo link ao seu amigo.",
  match_duel_own_invite: "Este é o seu próprio link de convite — compartilhe-o com um amigo.",
  match_duel_back_to_game: "Voltar à Sala de Jogos",
  match_duel_invited_by: "Convidado por",
  match_duel_already_claimed: "Este convite já foi aceito.",
  match_duel_lock_note: "Os palpites bloqueiam 5 min antes do início",
  match_duel_accept_cta: "Aceitar desafio",
...
const he: Translations = {
  ...
  nav_testing:       "בדיקות",
  nav_delete_user:   "מחיקת משתמש",
  nav_legacy_dashboard: "לוח בקרה ישן",
  nav_section_social:      "חברתי",
  nav_section_game:        "משחק",
  nav_section_predictions: "ניחושים",
  nav_section_tournament:  "טורניר",
  sidebar_tagline:   "ליגת הניחושים",
  sidebar_guest_heading: "מוכנים להתחרות?",
  sidebar_guest_body: "שמרו ניחושים, הצטרפו לקבוצות וטפסו בטבלה.",
  nav_table:         "טבלה",
  ...
  notif_push_match_duel: "תוצאת דו-קרב משחק",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — אתם {userScore} נק', היריב {opponentScore} נק'.",
  ...
  cg_mode_question:      "איך תרצה לנהל את הקבוצה הזו?",
  cg_house_rules_title:  "חוקי בית",
  cg_house_rules_badge:  "בלי הגדרות",
  cg_house_rules_desc:   "ניקוד סטנדרטי, מוכן מיד. בחר תחרות והתחל לשחק.",
  cg_customizable_title: "מותאם אישית",
  cg_customizable_desc:  "הגדר ניקוד, קופת פרסים ודמי השתתפות משלך.",
  cg_competition_label:  "תחרות",
  ...
  oracle_game_history_link: "לצפייה בהיסטוריה המלאה ←",
  oracle_history_page_title: "היסטוריית המגיד",
  oracle_history_page_subtitle: "כל התחזיות שהמגיד נתן אי פעם.",
  oracle_history_filter_mine: "המשחקים שלך",
  oracle_history_filter_all: "כל תחזיות המגיד",
  oracle_history_filter_empty: "אין עדיין משחקים כאן.",
  ...
  match_duel_widget_title: "דו-קרב משחק",
  match_duel_sign_in_required: "התחברו כדי לאתגר חבר במשחק.",
  match_duel_challenge_cta: "אתגרו חבר",
  match_duel_empty: "אין עדיין דו-קרבות משחק — אתגרו חבר לניחוש תוצאה ראש בראש.",
  match_duel_waiting_claim: "ממתינים שמישהו יאשר את הקישור שלכם",
  match_duel_share_again: "שתפו שוב",
  match_duel_challenged_you: "אתגר אתכם",
  match_duel_waiting_response: "ממתינים לתשובה",
  match_duel_declined: "נדחה",
  match_duel_your_pick: "הניחוש שלכם: {home}-{away}",
  match_duel_score_submit: "שליחה",
  match_duel_locked_no_pick: "נעול — לא נשלח ניחוש",
  match_duel_back: "חזרה",
  match_duel_step_pick_match_title: "בחרו משחק",
  match_duel_search_match_placeholder: "חיפוש לפי קבוצה…",
  match_duel_no_matches_found: "לא נמצאו משחקים קרובים.",
  match_duel_link_copied: "הועתק!",
  match_duel_share_link_cta: "שיתוף קישור הזמנה",
  match_duel_pick_friend_cta: "בחירה מהקבוצות שלכם",
  match_duel_search_friend_placeholder: "חיפוש לפי שם…",
  match_duel_no_players_found: "לא נמצאו שחקנים.",
  match_duel_join_group_hint: "הצטרפו לקבוצה כדי לראות כאן חברי קבוצה, או חפשו לפי שם.",
  match_duel_share_text: "אתגרתי אתכם לנחש את {home} מול {away}! חושבים שתוכלו לנצח אותי?",
  match_duel_result_win: "ניצחתם",
  match_duel_result_lose: "הפסדתם",
  match_duel_result_tie: "תיקו",
  match_duel_invalid_title: "קישור לא תקין",
  match_duel_invalid_body: "הזמנת הדו-קרב הזו לא תואמת אף משחק. בקשו מהחבר שלכם קישור חדש.",
  match_duel_own_invite: "זהו קישור ההזמנה שלכם — שתפו אותו עם חבר במקום זאת.",
  match_duel_back_to_game: "חזרה לחדר המשחקים",
  match_duel_invited_by: "הוזמנתם על ידי",
  match_duel_already_claimed: "ההזמנה הזו כבר אושרה.",
  match_duel_lock_note: "ניחושים ננעלים 5 דקות לפני תחילת המשחק",
  match_duel_accept_cta: "קבלת האתגר",
...
const ar: Translations = {
  ...
  nav_summary:       "ملخص",
  nav_scores:        "النتائج",
  nav_game:          "غرفة الألعاب",
  nav_stats:         "الإحصائيات",
  nav_testing:       "الاختبار",
  nav_delete_user:   "حذف المستخدم",
  nav_legacy_dashboard: "لوحة التحكم القديمة",
  nav_section_social:      "اجتماعي",
  nav_section_game:        "لعبة",
  nav_section_predictions: "التوقعات",
  nav_section_tournament:  "البطولة",
  sidebar_tagline:   "دوري التوقعات",
  sidebar_guest_heading: "جاهز للمنافسة؟",
  sidebar_guest_body: "احفظ توقعاتك، انضم إلى المجموعات، وتصاعد في لوحة الصدارة.",
  nav_table:         "الجدول",
  nav_mybets:        "توقعاتي",
  ...
  notif_push_match_duel: "نتيجة مبارزة المباراة",
  ...
  notif_push_match_duel_body:          "{home} {actualHome}-{actualAway} {away} — أنت {userScore} نقطة، خصمك {opponentScore} نقطة.",
  ...
  cg_step_prizes:     "Prizes",
  cg_step_scoring:    "Scoring",
  cg_mode_question:      "كيف تريد إدارة هذه المجموعة؟",
  cg_house_rules_title:  "القواعد الأساسية",
  cg_house_rules_badge:  "بدون إعداد",
  cg_house_rules_desc:   "نظام تسجيل نقاط قياسي وجاهز فورًا. اختر بطولة وابدأ اللعب.",
  cg_customizable_title: "قابل للتخصيص",
  cg_customizable_desc:  "حدد نظام النقاط الخاص بك وصندوق الجوائز ورسوم الاشتراك.",
  cg_competition_label:  "البطولة",
  cg_group_name:      "Group Name",
  cg_company_name:    "Company Group Name",
  cg_group_type:      "Group Type",
  ...
  oracle_game_history_link: "عرض السجل الكامل ←",
  oracle_history_page_title: "سجل العرّاف",
  oracle_history_page_subtitle: "كل التوقعات التي قدّمها العرّاف.",
  oracle_history_filter_mine: "مبارياتك",
  oracle_history_filter_all: "كل توقعات العرّاف",
  oracle_history_filter_empty: "لا توجد مباريات هنا بعد.",
  ...
  match_duel_widget_title: "مبارزة المباراة",
  match_duel_sign_in_required: "سجّل الدخول لتحدي صديق في مباراة.",
  match_duel_challenge_cta: "تحدَّ صديقًا",
  match_duel_empty: "لا توجد مبارزات مباراة بعد — تحدَّ صديقًا بتوقع نتيجة وجهًا لوجه.",
  match_duel_waiting_claim: "في انتظار أن يقبل أحدهم رابطك",
  match_duel_share_again: "مشاركة مرة أخرى",
  match_duel_challenged_you: "تحدّاك",
  match_duel_waiting_response: "في انتظار الرد",
  match_duel_declined: "مرفوض",
  match_duel_your_pick: "توقعك: {home}-{away}",
  match_duel_score_submit: "إرسال",
  match_duel_locked_no_pick: "مقفل — لم يُرسل أي توقع",
  match_duel_back: "رجوع",
  match_duel_step_pick_match_title: "اختر مباراة",
  match_duel_search_match_placeholder: "ابحث باسم الفريق…",
  match_duel_no_matches_found: "لم يتم العثور على مباريات قادمة.",
  match_duel_link_copied: "تم النسخ!",
  match_duel_share_link_cta: "مشاركة رابط الدعوة",
  match_duel_pick_friend_cta: "الاختيار من مجموعاتك",
  match_duel_search_friend_placeholder: "ابحث بالاسم…",
  match_duel_no_players_found: "لم يتم العثور على لاعبين.",
  match_duel_join_group_hint: "انضم إلى مجموعة لرؤية زملائك هنا، أو ابحث بالاسم.",
  match_duel_share_text: "تحديتك لتوقع نتيجة {home} ضد {away}! هل تظن أنك تستطيع هزيمتي؟",
  match_duel_result_win: "لقد فزت",
  match_duel_result_lose: "لقد خسرت",
  match_duel_result_tie: "تعادل",
  match_duel_invalid_title: "رابط غير صالح",
  match_duel_invalid_body: "دعوة المبارزة هذه لا تطابق أي مباراة. اطلب من صديقك رابطًا جديدًا.",
  match_duel_own_invite: "هذا رابط الدعوة الخاص بك — شاركه مع صديق بدلاً من ذلك.",
  match_duel_back_to_game: "العودة إلى غرفة الألعاب",
  match_duel_invited_by: "دعوة من",
  match_duel_already_claimed: "تم قبول هذه الدعوة بالفعل.",
  match_duel_lock_note: "تُقفل التوقعات قبل 5 دقائق من الانطلاق",
  match_duel_accept_cta: "قبول التحدي",
