          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "text-white"
                  : "text-pitch-400 hover:text-pitch-200 hover:bg-white/[0.04]"
              )}
              style={
                active
                  ? {
      ...
      <div className="px-3 py-3 border-t border-white/[0.08]">
        <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-white/[0.03]">
          ...
          <div className="min-w-0">
            <div className="text-xs font-bold text-pitch-200 truncate">
              Amit
            </div>
            <div className="text-[10px] text-pitch-400 uppercase tracking-wider">
              🇦🇷 Argentina
            </div>
          </div>
