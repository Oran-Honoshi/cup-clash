    ...
    <div className="rounded-2xl overflow-hidden"
      ...
      <div className="border-t p-5 space-y-4" style={{ borderColor: "rgba(0,212,255,0.1)" }}>
        <div className="text-center">
          ...
          <h3 className="font-display text-lg uppercase font-black mb-1" style={{ color: "#0F172A" }}>
            Ready to invite your team?
          </h3>
          <p className="text-xs" style={{ color: "#64748b" }}>
            One flat fee — employees join for <strong style={{ color: "#0F172A" }}>$0</strong>
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link href={`/groups/${groupId}/unlock`}
            ...
            <div className="font-display text-2xl font-black mb-0.5" style={{ color: "#0F172A" }}>$75</div>
          ...
          <Link href={`/groups/${groupId}/unlock`}
            ...
            <div className="font-display text-2xl font-black mb-0.5" style={{ color: "#0F172A" }}>$130</div>
        ...
        <div className="flex items-center justify-between">
          <p className="text-xs" style={{ color: "#94a3b8" }}>Need more than 100 members?</p>
          <a href="/contact"
