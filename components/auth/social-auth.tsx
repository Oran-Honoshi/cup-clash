  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <p className="text-center" style={{ fontSize: 10, color: "rgba(255,255,255,0.25)", fontFamily: "var(--font-ui)" }}>
          You may see &apos;supabase.co&apos; during Google sign-in — this is normal and secure.
        </p>
      ...
      <button disabled className={cn(btnClass, "w-full opacity-50 cursor-not-allowed")}>
