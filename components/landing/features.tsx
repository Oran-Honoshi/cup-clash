    ...
    <section id="features" className="py-12 px-5 sm:px-8"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="mt-8 rounded-2xl p-6 flex items-center justify-between gap-6 flex-wrap"
          style={{ background: "rgba(255,255,255,0.7)", backdropFilter: "blur(12px)", border: "1px solid rgba(0,212,255,0.2)", boxShadow: "0 4px 24px rgba(0,212,255,0.06)" }}>
