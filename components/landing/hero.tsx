  ...
  return (
    ...
    >
      <div className="relative rounded-[2.5rem] overflow-hidden"
        style={{ background: "#111d27", border: "2px solid rgba(255,255,255,0.12)" }}>
        ...
        <div className="pt-8 pb-4 px-4 space-y-3" style={{ background: "#050a0f" }}>
            ...
            {[
              ...
              <div key={p.name} className="flex items-center gap-2"
                ...
                <div className="h-5 w-5 rounded-full flex items-center justify-center text-[8px] font-bold text-white"
                  style={{ background: "linear-gradient(135deg, #2A398D, #E61D25)" }}>{p.name[0]}</div>
          ...
          <div className="rounded-2xl p-3" style={{ background: "#111d27", border: "1px solid rgba(16,185,129,0.2)" }}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-center"><div className="text-sm">🇧🇷</div><div className="text-[9px] text-white font-bold">BRA</div></div>
              <div className="flex gap-1 items-center">
                <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm font-bold text-white" style={{ background: "rgba(255,255,255,0.08)" }}>2</div>
                <div className="text-white text-lg font-bold">–</div>
                <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm font-bold text-white" style={{ background: "rgba(255,255,255,0.08)" }}>1</div>
              </div>
              <div className="text-center"><div className="text-sm">🇫🇷</div><div className="text-[9px] text-white font-bold">FRA</div></div>
            </div>
            <div className="mt-2 w-full rounded-lg py-1.5 text-center text-[9px] font-bold uppercase tracking-widest text-white"
              style={{ background: "linear-gradient(135deg, #2A398D, #10b981)" }}>Lock in prediction →</div>
          </div>
  ...
  return (
    <section className="relative overflow-hidden pt-24 pb-0 sm:pt-32">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(16,185,129,0.06) 0%, transparent 60%)" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center min-h-[85vh] pb-20">
          ...
          <div className="relative z-10 py-12 lg:py-0">
            ...
            >
              ...
              <span style={{ color: "#E61D25" }}>DOES.</span>
            </motion.h1>

            {/* Sub-headline — Gemini option 1 */}
            <motion.p
            ...
            >
              ...
              <strong style={{ color: "#f5f5f5" }}>Run your World Cup pool like a pro</strong>{" "}
            ...
            >
              <Link href="/signup">
                <button className="flex items-center gap-2 px-7 py-4 rounded-full font-bold text-base uppercase tracking-wider text-white transition-all hover:-translate-y-0.5"
                  style={{ background: "linear-gradient(135deg, #10b981, #059669)", boxShadow: "0 4px 24px rgba(16,185,129,0.5)" }}>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
              ...
              <div className="flex gap-0.5">{[1,2,3,4,5].map(s => <span key={s} style={{ color: "#f59e0b" }}>★</span>)}</div>
            </motion.div>
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="h-96 w-96 rounded-full blur-3xl opacity-20" style={{ background: "#10b981" }} />
            </div>
            <PhoneMockup />
      ...
      {/* Host nations bar */}
      <div className="border-t border-b py-4 px-5" style={{ borderColor: "rgba(255,255,255,0.06)", background: "rgba(17,29,39,0.5)" }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-6 flex-wrap">
          <div className="text-xs font-bold uppercase tracking-widest" style={{ color: "#64748b" }}>Host Nations</div>
          <div className="flex items-center gap-6">
            {[
              ...
              <div key={name} className="flex items-center gap-2">
                ...
                <div><div className="text-xs font-bold text-white">{name}</div><div className="text-[10px]" style={{ color: "#64748b" }}>{matches}</div></div>
              </div>
            ))}
          </div>
          <div className="text-xs font-bold" style={{ color: "#64748b" }}>48 teams · 104 matches · 16 host cities</div>
        </div>
      </div>
      ...
      <div className="overflow-hidden py-2.5" style={{ background: "rgba(16,185,129,0.06)", borderBottom: "1px solid rgba(16,185,129,0.15)" }}>
        <div className="flex animate-ticker whitespace-nowrap">
          {[...TICKER_ITEMS, ...TICKER_ITEMS].map((item, i) => (
            <span key={i} className="text-xs font-bold uppercase tracking-widest mx-8" style={{ color: "#10b981" }}>{item}</span>
          ))}
        </div>
      </div>
    </section>
