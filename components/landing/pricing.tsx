...
function PlaystyleCallout() {
  return (
    ...
    >
      <div className="text-xs font-black uppercase tracking-widest mb-4" style={{ color: "#0891B2" }}>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-black uppercase tracking-wide" style={{ color: "#0F172A" }}>
          ...
          <div className="space-y-2">
            ...
            >
              <div className="text-xs font-black mb-0.5" style={{ color: "#059669" }}>For Friends</div>
              <div className="text-xs" style={{ color: "#475569" }}>
                The host sets it up for free. Players pay a one-time <strong>$2 entry fee</strong> to unlock the live leaderboard and all predictions.
              </div>
            </div>
            <div
              className="rounded-xl p-3"
            ...
            >
              <div className="text-xs font-black mb-0.5" style={{ color: "#4F46E5" }}>For Companies</div>
              <div className="text-xs" style={{ color: "#475569" }}>
                The company pays a single flat fee ($75 or $130). All employees join <strong>100% free</strong> with zero checkout friction.
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-16 px-5 sm:px-8" style={{ background: "#F8FAFC" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch">
                ...
                <div>
                  <div className="flex items-center gap-2.5 mb-2">
                    ...
                    <div>
                      ...
                      <div className="text-[10px]" style={{ color: "#94a3b8" }}>Global public leaderboard</div>
                    </div>
                  </div>
                  {/* Playstyle tag */}
                  <div
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest mb-4"
                ...
                <div>
                  <div className="flex items-center gap-2.5 mb-2">
                    ...
                    <div>
                      ...
                      <div className="text-[10px]" style={{ color: "#94a3b8" }}>Private group · Invite only</div>
                    </div>
                  </div>
                  {/* Playstyle tag */}
                  <div
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest mb-4"
                    style={{ background: "rgba(0,255,136,0.07)", color: "#059669", border: "1px solid rgba(0,255,136,0.15)" }}
                  >
                  ...
                  <div className="text-xs mb-5" style={{ color: "#64748b" }}>
                    One-time entry · Admin always free
                  </div>
                  <div className="space-y-2 mb-6">
            ...
            {/* Tier 3 — Team Starter (dark / Most Popular) */}
            <motion.div
              initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            >
              <div
                className="absolute top-4 right-4 px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest"
              ...
              <div className="p-6 flex flex-col flex-1 justify-between">
                <div>
                  ...
                  <div className="text-xs mb-5" style={{ color: "rgba(255,255,255,0.4)" }}>
                    Company pays once · Whole team joins free
                  </div>
                  <div className="space-y-2 mb-6">
            ...
            {/* Tier 4 — Corporate Pack (Indigo) */}
            <motion.div
              initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ delay: 0.24 }}
              className="rounded-3xl overflow-hidden flex flex-col h-full"
              style={{ background: "white", border: "1px solid #E2E8F0", boxShadow: "0 4px 20px rgba(15,23,42,0.05)" }}
            >
              ...
              <div className="p-6 flex flex-col flex-1 justify-between">
                <div>
                  ...
                  <div
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest mb-4"
                    style={{ background: "rgba(99,102,241,0.07)", color: "#4F46E5", border: "1px solid rgba(99,102,241,0.15)" }}
                  >
                    <Building2 size={9} /> Corporate · Employees join free
                  </div>
                  <div className="mb-1">
                  ...
                  <div className="space-y-2 mb-6">
                    {CORPORATE_FEATURES.map(f => (
                      <div key={f} className="flex items-start gap-2">
                        ...
                        >
                          <Check size={9} style={{ color: "#4F46E5" }} />
                        </div>
                        <span className="text-xs leading-relaxed" style={{ color: "#475569" }}>{f}</span>
                      </div>
                    ))}
                ...
                <div className="mt-auto">
                  ...
                  <div className="mt-4 pt-3 border-t text-center" style={{ borderColor: "#F1F5F9" }}>
                    <p className="text-[11px] mb-0.5" style={{ color: "#94a3b8" }}>Need more than 100 slots?</p>
                    <button
                      onClick={() => setShowEnterprise(true)}
                      className="text-xs font-bold uppercase tracking-wide transition-colors hover:opacity-75"
                      style={{ color: "#4F46E5" }}
                    >
